export const arrows = (
  <svg width={8.828} height={10.414} viewBox="0 0 8.828 10.414">
    <path
      d="M1.414 4.414l3-3m0 0l3 3m-3-3v8"
      fill="currentColor"
      stroke="currentColor"
      strokeLinecap="round"
...
export const moon = (
  <svg viewBox="0 0 20 20" fill="currentColor">
    <path d="M8 2c-3.5.9-6 4.1-6 7.9 0 4.5 3.6 8.1 8.1 8.1 3.8 0 6.9-2.5 7.9-6C11.9 13.7 6.3 8.1 8 2z" />
  </svg>
);
